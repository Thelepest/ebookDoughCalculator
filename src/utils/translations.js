const translations = {
    PL: {
        ...
        recipesButton:"Przepisy",
        recipesTitle:"Przepisy",
        difficultyEasy:"Świetne na początek",
        difficultyMedium:"Podnosimy poprzeczkę?",
        difficultyHard:"Przepisy Premium",
        ingredients:"Składniki",
        process:"Proces",
        goToRecipe:"Przejdź do przepisu",
        premiumTitle:"Treści Premium",
        premiumDescription:"Uzyskaj dostęp do treści premium, aby odblokować ekskluzywne przepisy i zaawansowane funkcje!",
        premiumFeatures:"Co zawiera:",
        premiumFeature1:"Ekskluzywne przepisy Premium",
        premiumFeature2:"Zaawansowane treści",
        premiumFeature3:"Priorytetowe wsparcie",
        upgradeNow:"Przejdź na Premium",
        premiumLocked:"Premium",
        unlockPremium:"Odblokuj Premium",
        networkError:"Problem z połączeniem. Sprawdź swoją sieć i spróbuj ponownie.",
        buns:"Bułeczki do burgerów",
        panBrioche:"Brioszka",
        panettoneMilanese:"Panettone po mediolańsku",
        paneBurro:"Chleb maślany",
        close:"Zamknij",
        teachMe:"Pomóż mi!",
        help:"Pomoc",
        ...
        forgotPassword: {
            ...
            emailRequired: 'Proszę wprowadzić adres email.',
            send: 'Wyślij email resetujący',
            sending: 'Wysyłanie...',
        ...
        privacyPolicy: {
            ...
            termsText: 'Korzystając z tej aplikacji, zgadzasz się używać jej odpowiedzialnie i zgodnie z obowiązującym prawem. Aplikacja jest dostarczana "tak jak jest" bez gwarancji. Zastrzegamy sobie prawo do modyfikacji tych warunków w dowolnym momencie.',
            contactTitle: 'Kontakt',
            contactText: 'W przypadku pytań dotyczących prywatności lub przetwarzania danych, skontaktuj się z nami poprzez ustawienia aplikacji.',
            acceptPrivacy: 'Przeczytałem i akceptuję Politykę Prywatności',
            acceptTerms: 'Przeczytałem i akceptuję Warunki Użytkowania',
            continue: 'Kontynuuj',
            saving: 'Zapisywanie...',
            version: 'Wersja 1.0 - Data ostatniej aktualizacji: 2025',
            legalBasisTitle: 'Podstawa Prawna i Przetwarzanie Danych',
            legalBasis: 'Podstawa prawna: Zgoda użytkownika (art. 6 ust. 1 lit. a RODO)',
        ...
        deleteAccount: {
            title: 'Usuń konto',
            message: 'Czy na pewno chcesz usunąć swoje konto? Ta operacja jest nieodwracalna i spowoduje trwałe usunięcie wszystkich Twoich danych.',
            warning: 'Uwaga: Ta akcja nie może być cofnięta!',
    ...
    EN: {
        ...
        difficultyEasy:"Great to start",
        difficultyMedium:"Level up?",
        difficultyHard:"Premium Recipes",
        ingredients:"Ingredients",
        process:"Process",
        goToRecipe:"Go to recipe",
        premiumTitle:"Premium Content",
        premiumDescription:"Access premium content to unlock exclusive recipes and advanced features!",
        premiumFeatures:"What's included:",
        premiumFeature1:"Exclusive Premium recipes",
        premiumFeature2:"Advanced content",
        ...
        buns:"Buns",
        panBrioche:"Pan Brioche",
        panettoneMilanese:"Panettone \"milanese\" style",
        paneBurro:"Butter Bread",
        chatNow:"Chat Now",
        close:"Close",
        teachMe:"Help me!",
        help:"Help",
        ...
        privacyPolicy: {
            ...
            termsText: 'By using this app, you agree to use it responsibly and in accordance with applicable laws. The app is provided "as is" without warranties. We reserve the right to modify these terms at any time.',
            contactTitle: 'Contact',
            contactText: 'For questions about privacy or data processing, please contact us through the app settings.',
            acceptPrivacy: 'I have read and accept the Privacy Policy',
            acceptTerms: 'I have read and accept the Terms of Service',
            continue: 'Continue',
            saving: 'Saving...',
            version: 'Version 1.0 - Last updated: 2025',
            legalBasisTitle: 'Legal Basis & Data Processing',
            legalBasis: 'Legal basis: User consent (GDPR Art. 6(1)(a))',
        ...
        deleteAccount: {
            ...
            message: 'Are you sure you want to delete your account? This action is irreversible and will permanently delete all your data.',
    ...
    IT: {
        ...
        recipesButton:"Ricette",
        recipesTitle:"Ricette",
        difficultyEasy:"Ottime per cominciare",
        difficultyMedium:"Alziamo l'asticella?",
        difficultyHard:"Ricette Premium",
        ingredients:"Ingredienti",
        process:"Processo",
        goToRecipe:"Vai alla ricetta",
        premiumTitle:"Contenuti Premium",
        premiumDescription:"Accedi ai contenuti premium per sbloccare ricette esclusive e funzionalità avanzate!",
        premiumFeatures:"Cosa include:",
        premiumFeature1:"Ricette Premium esclusive",
        premiumFeature2:"Contenuti avanzati",
        premiumFeature3:"Supporto prioritario",
        upgradeNow:"Passa a Premium",
        premiumLocked:"Premium",
        unlockPremium:"Sblocca Premium",
        networkError:"Problema di connessione. Controlla la tua rete e riprova.",
        buns:"Brioches",
        panBrioche:"Pan Brioche",
        panettoneMilanese:"Panettone stile \"milanese\"",
        paneBurro:"Pane al burro",
        ...
        privacyPolicy: {
            ...
            termsText: 'Utilizzando questa app, accetti di usarla in modo responsabile e in conformità con le leggi applicabili. L\'app è fornita "così com\'è" senza garanzie. Ci riserviamo il diritto di modificare questi termini in qualsiasi momento.',
            contactTitle: 'Contatto',
            contactText: 'Per domande sulla privacy o sul trattamento dei dati, contattaci attraverso le impostazioni dell\'app.',
            acceptPrivacy: 'Ho letto e accetto la Privacy Policy',
            acceptTerms: 'Ho letto e accetto i Termini di Servizio',
            continue: 'Continua',
            saving: 'Salvataggio...',
            version: 'Versione 1.0 - Ultimo aggiornamento: 2025',
            legalBasisTitle: 'Base Giuridica e Trattamento Dati',
            legalBasis: 'Base giuridica: Consenso dell\'utente (GDPR Art. 6(1)(a))',
        ...
        deleteAccount: {
            ...
            message: 'Sei sicuro di voler eliminare il tuo account? Questa operazione è irreversibile e eliminerà permanentemente tutti i tuoi dati.',
            warning: 'Attenzione: Questa azione non può essere annullata!',
            confirm: 'Sì, Elimina Account',
            cancel: 'Annulla',
